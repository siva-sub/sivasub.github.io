...
export const SOURCES: SourceInfo[] = [
  ...
  },
  {
    ...
    full: 'Visa Intelligent Commerce — Trusted Agent Protocol & Agent APIs',
  ...
  {
    name: 'Google Pay',
    full: 'Google Pay for Business — API and product patterns for consent-based payment delegation',
  ...
  {
    name: 'FSB',
    full: 'Financial Stability Board — Cross-border payments, token rails, and regulatory frameworks',
...
export const SOURCE_URLS: Record<string, string> = {
  'Stripe SPT': 'https://docs.stripe.com/api/payment_intents',
  'Visa / MC': 'https://corporate.visa.com/en/products/intelligent-commerce.html',
  'Visa Intelligent Commerce': 'https://corporate.visa.com/en/products/intelligent-commerce.html',
  'BIS CPMI': 'https://www.bis.org/cpmi/about/overview.htm',
  'Google AP2': 'https://pay.google.com/about/business/',
  'Google Pay': 'https://pay.google.com/about/business/',
  'BIS/FSB': 'https://www.fsb.org/',
